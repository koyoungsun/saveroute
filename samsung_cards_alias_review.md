...
|---|---|---|---|
| credit | 롯데월드카드 | 삼성카드 롯데월드 | `samsung_cred_x216cc609d09e` |
| credit | 삼성 BIZ iD BENEFIT카드 | 삼성카드 BIZ iD BENEFIT | `samsung_cred_biz_id_benefit` |
| credit | 삼성카드 & MILEAGE PLATINUM (스카이패스) | 삼성카드 & MILEAGE PLATINUM(스카이패스) | `samsung_cred_mileage_platinum` |
| credit | iD MOVE카드 | 삼성 iD MOVE 카드 | `samsung_cred_id_move` |
