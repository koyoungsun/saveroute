-- 카드고릴라 기준 삼성카드 benefit_products 신규 INSERT 멱등 (생성물)
-- 생성: npm run sync:samsung-cardgorilla — 2026-05-19
--
...
-- 신규 insert 대상 행 수: 88 (credit 80, debit 8)
-- alias 표기 차이 매칭(신규 insert 생략) pair 수: 7
-- deprecated 검토 후보 리포 내 시드 미포함: 45
--
